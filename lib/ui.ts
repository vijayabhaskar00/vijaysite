...
export const linkClass =
  "text-signal underline-offset-4 hover:underline focus-visible:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-signal/40 rounded-sm";
...
export const navLinkClass =
  "text-mute transition-colors hover:text-amber focus-visible:text-amber focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-signal/40 rounded-sm";
